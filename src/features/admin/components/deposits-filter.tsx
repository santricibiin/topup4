...
const STATUS_OPTS: readonly StatusOption[] = [
...
export function DepositsFilter({ initialQ = "", initialStatus = "ALL" }: Props) {
  ...
  function apply(nextQ: string, nextStatus: string) {
    ...
    start(() => {
      router.replace(qs ? `/admin/deposits?${qs}` : "/admin/deposits");
    });
  }
    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <input
          ...
          placeholder="Cari deposit ID, username, atau email..."
